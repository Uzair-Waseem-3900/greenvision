          ...
          <tbody>
            {scans.map((s, i) => {
              ...
              return (
                ...
                >
                  <td className="whitespace-nowrap px-4 py-3 font-medium text-[color:var(--mist)]">{s.tree}</td>
                  <td className="whitespace-nowrap px-4 py-3 text-[color:var(--mist-dim)]">{s.park}</td>
                  ...
                  <td className="whitespace-nowrap px-4 py-3 font-mono text-[color:var(--mist)]">{s.confidence}%</td>
                  <td className="whitespace-nowrap px-4 py-3 text-[color:var(--mist-dim)]">{s.time}</td>
                </motion.tr>
              );
            })}
          </tbody>
